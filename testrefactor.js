...
function setup() {
    ...
    test= new Grafo();
    test.Insert(0,"Zona en \nObras",[],{x:ancho/1.395, y:alto/1.2,r:alto/4.2,c:'black'});
    //alrededor de la Plaza
    test.Insert(1,"Plaza \nChe",[2,3,4,5],{x:ancho/1.82, y:alto/1.05,r:alto/10,c:'red'});
    ...
    test.Insert(7,"Fac. \nEconomia",[6],{x:ancho/1.2, y:alto/1.15,r:alto/15,c:'yellow'});
    ...
    test.Insert(10,"Patios \nIng.",[9,11,19],{x:ancho/1.3, y:alto/2.8,r:alto/15,c:'yellow'});
    ...
    test.Insert(18,"Fac. \nQuimica",[20,21,24,25,28,30],{x:ancho/1.72, y:alto/2.2,r:alto/15,c:'yellow'});
    test.Insert(19,"Lab. \nQuímica",[20,10,11,21,25],{x:ancho/1.49, y:alto/2.8,r:alto/15,c:'yellow'});
    ...
    test.Insert(22,"Fac. \nMatemáticas",[25,26],{x:ancho/1.4, y:alto/1.75,r:alto/15,c:'yellow'});
    test.Insert(23,"Fac. \nIngeniería",[2,24,25,26],{x:ancho/1.6, y:alto/1.6,r:alto/15,c:'yellow'});
    test.Insert(24,"Fac. \nEnfermeria",[2,18,23,25],{x:ancho/1.75, y:alto/1.75,r:alto/15,c:'yellow'});
    ...
    test.Insert(27,"Bienestar \nIng.",[41],{x:ancho/1.2, y:alto/1.75,r:alto/15,c:'yellow'});
    //Alrededor del CyT
    ...
    test.Insert(31,"Fac. de \nMedicina",[32,35],{x:ancho/2.4, y:alto/1.7,r:alto/15,c:'yellow'});
    ...
    test.Insert(34,"Fac. de \nCiencias",[14],{x:ancho/2.7, y:alto/2.7,r:alto/15,c:'yellow'});
    test.Insert(35,"Dir. \nInnovación",[30,31,32],{x:ancho/2.7, y:alto/1.9,r:alto/15,c:'yellow'});
    test.Insert(36,"Fac. de \nVeterinaria",[17,37],{x:ancho/3, y:alto/1.65,r:alto/15,c:'yellow'});
    //Puntos Adicionales
    ...
    test.Insert(40,"Fac. de \nArtes",[2],{x:ancho/1.57, y:alto/1.15,r:alto/15,c:'yellow'});
